...
//                    SimpleDateFormat sdf1 = new SimpleDateFormat(" HH:mm ");
//                    String temp2 = sdf1.format(currenTimeZone);
//                    return temp1 + temp2 + getWeekDayStr(inputTime.get(Calendar.DAY_OF_WEEK));
                    return temp1 + getWeekDayStr(inputTime.get(Calendar.DAY_OF_WEEK));
                } else {
